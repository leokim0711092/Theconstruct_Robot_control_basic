...
d_sp_q=lambda t:np.array([[0.5*f1*np.cos(f1*t)],[-0.75*f2*np.sin(f2*t)]])
dd_sp_q=lambda t:np.array([[-0.5*f1*f1*np.sin(f1*t)],[-0.75*f2*f2*np.cos(f2*t)]])
